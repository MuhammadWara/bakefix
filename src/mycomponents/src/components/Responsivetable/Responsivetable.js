...
<section id="container" className>
            ...
            <div className="row">
              <div className="col-lg-12">
                ...
                <ol className="breadcrumb">
                  ...
                  <li><i className="fa fa-th-list" />Responsive Table</li>
                </ol>
              </div>
            </div>
            </section>
        ...
        <div className="table-responsive">
          <table className="table table-striped b-t b-light">
            ...
            <tbody>
              <tr>
                <td><label className="i-checks m-b-none"><input type="checkbox" name="post[]" /><i /></label></td>
                <td>Idrawfast prototype design prototype design prototype design prototype design prototype design</td>
                <td><span className="text-ellipsis">{'{'}item.PrHelpText1{'}'}</span></td>
                <td><span className="text-ellipsis">{'{'}item.PrHelpText1{'}'}</span></td>
                <td>
                  <a href className="active" ui-toggle-class><i className="fa fa-check text-success text-active" /><i className="fa fa-times text-danger text" /></a>
                </td>
              </tr>
              <tr>
                <td><label className="i-checks m-b-none"><input type="checkbox" name="post[]" /><i /></label></td>
                ...
                <td>Jul 22, 2013</td>
                <td>
                  <a href ui-toggle-class><i className="fa fa-check text-success text-active" /><i className="fa fa-times text-danger text" /></a>
                </td>
              </tr>
              <tr>
                <td><label className="i-checks m-b-none"><input type="checkbox" name="post[]" /><i /></label></td>
