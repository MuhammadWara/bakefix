          ...
          <div id="sidebar" className="nav-collapse ">
            ...
            <ul className="sidebar-menu">
              ...
              <li className="sub-menu">
                ...
                <ul className="sub">
                  <li><a className ComponentClass={Link} href="/Genaral" to="/General">Components</a></li>
              ...
              <li className="sub-menu">
                ...
                <ul className="sub">
                  ...
                  <li><a ComponentClass={Link} href="/Compose" to="/Compose"><span>Compose Mail</span></a></li>
