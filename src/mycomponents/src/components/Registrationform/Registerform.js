...
<div className="container">
        ...
        <div className="login-wrap">
          ...
          <h2 className="text-center"> Register Now</h2><br/>
          ...
          <div className="input-group">
           ...
           <div className="input-group">
            ...
            <button className="btn btn-primary btn-lg btn-block" type="submit">SUBMIT</button></a>
            </div>
            <p className=" text-success">Already Registered.
            <a ComponentClass={Link} href="/Loginform" to="/Loginform" ><u className="text-primary">LOGIN</u></a></p><br/>
          </form>
